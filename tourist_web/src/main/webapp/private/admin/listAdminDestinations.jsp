...
<body style="width: 60%; margin: auto">
	...
	<div id="divdt">
		...
		<d:table name="destinations" export="true"
			requestURI="/getAllAdminDestinations"
			 decorator="com.decorators.ModifyDestinationDecorator" pagesize="20">
			<d:column property="nomDest" title="Destination" sortable="true" />
			<d:column property="note" title="note" sortable="true" />
			

			<d:column property="addModifyLink" title="Action" media="html" />
		</d:table>
