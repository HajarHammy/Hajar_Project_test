...
public class UserAction extends BaseAction {
	...
	@Actions({
	@Action(value = "/", results = { @Result(name = "success", location = "listDestinations.jsp") }),

	@Action(value = "/getAllDestinations", results = { @Result(name = "success", location = "listDestinations.jsp") })
